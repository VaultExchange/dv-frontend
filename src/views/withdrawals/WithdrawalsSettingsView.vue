      ...
      try {
        await this.updateExchangeSettings({
          ...
          payload: {
            ...
            exchangeCurrenciesFrom: this.exchangeCurrenciesPair[this.exchangeSelected][0]?.fromCurrencyId
              ? this.exchangeCurrenciesPair[this.exchangeSelected][0].fromCurrencyId : null,
            exchangeCurrenciesTo: this.exchangeCurrenciesPair[this.exchangeSelected][0]?.toCurrencyId
              ? this.exchangeCurrenciesPair[this.exchangeSelected][0].toCurrencyId : null,
