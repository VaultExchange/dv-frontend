<template>
  ...
  >
    <div class="flex items-center gap-2 mb-4">
      ...
      <ui-tooltip :text="$t('These wallets using for the transfer tokens from processing wallets to user wallets')">
        <feather-icon
          type="help-circle"
          size="16"
          stroke-width="2.5"
...
import ProcessingBalancesAlertSimple from '@/components/dashboard/ProcessingBalancesAlertSimple.vue';
